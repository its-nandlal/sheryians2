...
export default function Header() {
  ...
  return (
    <div className='fixed top-0 left-0 z-2 w-full flex items-center justify-between p-5 backdrop-blur-md rounded-b-3xl'>
      ...
      <div className='2xl:w-1/2 flex items-center justify-between'>
        {/* Navigation */}
        ...
        <div className='flex items-center gap-4'>
          ...
          <ButtonPrimary size="sm" variant="outline" className='flex items-center gap-2 text-nowrap max-md:hidden'>
          ...
          <div ref={authRef} className='relative'>
            <ButtonPrimary 
              ...
              size="sm" 
              className='font-semibold relative z-2 text-nowrap'
            >
              Get Started
            </ButtonPrimary>
